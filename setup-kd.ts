...
export const KD_QUESTIONS: Question[] = [
  ...
  { id: 3, question: "Hành tinh nào gần Mặt Trời nhất?", answer: "Sao Thủy" },
  { id: 4, question: "Bác Hồ sinh năm bao nhiêu?", answer: "1890" },
  { id: 5, question: "Đơn vị đo cường độ dòng điện là gì?", answer: "Ampe (A)" },
  ...
  { id: 13, question: "Huyện đảo Hoàng Sa thuộc tỉnh/thành phố nào?", answer: "Đà Nẵng" },
  { id: 14, question: "Chất khí chiếm nhiều nhất trong không khí là gì?", answer: "Nitơ" },
  { id: 15, question: "Chiến thắng Điện Biên Phủ diễn ra năm nào?", answer: "1954" }
];